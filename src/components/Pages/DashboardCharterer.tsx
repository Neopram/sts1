...
export const DashboardCharterer: React.FC = () => {
  ...
  const getUrgencyStatus = (urgency: string): 'success' | 'warning' | 'critical' | 'info' => {
    switch (urgency) {
      case 'critical':
        return 'critical';
      case 'high':
  ...
  const getMarginStatus = (marginAtRisk: number): 'success' | 'warning' | 'critical' => {
